...
*/
	...
	public Pixel[][] Get_3x3_Neighborhood(int Height_Position,int Width_Position){
		Pixel[][] Result = new Pixel[3][3];
		Result[0][0] = this.Pixel_Matrix[Height_Position-1][Width_Position-1];
		Result[0][1] = this.Pixel_Matrix[Height_Position-1][Width_Position];
		Result[0][2] = this.Pixel_Matrix[Height_Position-1][Width_Position+1];
		Result[1][0] = this.Pixel_Matrix[Height_Position][Width_Position-1];
		Result[1][1] = this.Pixel_Matrix[Height_Position][Width_Position];
		Result[1][2] = this.Pixel_Matrix[Height_Position][Width_Position+1];
		Result[2][0] = this.Pixel_Matrix[Height_Position+1][Width_Position-1];
		Result[2][1] = this.Pixel_Matrix[Height_Position+1][Width_Position];
		Result[2][2] = this.Pixel_Matrix[Height_Position+1][Width_Position+1];
		return Result;
